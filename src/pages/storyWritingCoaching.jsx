        ...
        <section className=" hero">
          <div className="grid ss:py-40 xx:py-32 text-center img ss:px-12 xx:px-6 ">
            ...
            <p className="sm:text-2xl xx:text-xl xx:w-full ss:w-[75%] mx-auto  text-white xx:py-3  ss:py-6 ">
              If you want to train your team of content writers on how to sell
              with stories or you want to learn the art of compelling writing
              for yourself, it will take only 4 weeks to make that magic happen.
            </p>
